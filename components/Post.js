  ...
  return (
    ...
    >
      <div className="flex items-center px-2.5 cursor-pointer">
        ...
        <div className="mr-auto ml-2 laeding-none">
      ...
      <div className="flex justify-evently items-center dark:border-t border-gray-600/80 mx-2.5 pt-2 text-black/60 dark:text-white/75">
        {modalPost ? (
